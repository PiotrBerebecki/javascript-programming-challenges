...
/*
-----------------------------------------
Intermediate Algorithms - Everything to true
-----------------------------------------
...
function truthCheck(collection, pre) {
  return collection.every(el => el.hasOwnProperty(pre) && el[pre]);
}
// el[pre] could be replaced by Boolean(el[pre])
...
function truthCheck2(collection, pre) {
  ...
  for (var el in collection) {
    if (collection[el].hasOwnProperty(pre) && Boolean(collection[el][pre])) {
      counter++;
    }
  }
